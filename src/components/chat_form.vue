    ...
    <div id="chat-form">
        ...
        <div class="text-box">
                    ...
                    <div class="close" @click="clickOutside"></div>
                        <div class="file-list">
                            ...
                            <div v-for="(file, index) in filelist" :key="index">
                                <div class="preview">
                                    <img class="file-image" :id="'file-image_' + index" v-if="file.url" :src="file.url" />    
                                    ...
                                    <div class="file-name" :id="'name_'+index">{{file.name}}</div>
          ...
          <svg class="micro_icon" width="15" height="20" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button class="send" type="submit">Send
